...
const GetStarted = () => {
  ...
  return (
    <section id='GetStarted' className='md:h-screen grid grid-cols-1 md:grid-cols-2'>
      <div className={`${submitted ? 'hidden' : ''} my-auto p-16 order-last md:order-1`}>
      ...
      <div className={submitted ? 'flex flex-col justify-center items-center py-32 md:px-16 px-6 order-last md:order-1' : 'hidden'}>
      {/* <div className={submitted ? 'hidden' : 'flex flex-col justify-center items-center'}> */}
        ...
        <div>
          ...
          <p className='mt-36 mb-4'>follow me on Instagram</p>
